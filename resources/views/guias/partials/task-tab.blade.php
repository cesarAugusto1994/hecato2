<div class="mdl-color--grey-50 mdl-card dark-table mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-cell--12-col-tablet mdl-cell--12-col-desktop margin-top-0 mdl-tabs__panel {{{ $status or '' }}}" id="{{ $tab }}">
    ...
    <div class="mdl-card__supporting-text mdl-color-text--grey-700 padding-0">
        <div class="table-responsive material-table inverse">
            <table class="mdl-data-table mdl-js-data-table data-table mdl-shadow--2dp" cellspacing="0" width="100%">
                <thead>
                    <tr>
