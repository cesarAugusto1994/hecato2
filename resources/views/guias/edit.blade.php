    ...
    <div class="mdl-cell mdl-cell mdl-cell--12-col mdl-cell--12-col-phone mdl-cell--8-col-tablet mdl-cell--12-col-desktop mdl-card mdl-shadow--3dp margin-top-0 padding-top-0">
        ...
        {!! Form::model($guia, array('action' => ['GuiasController@update', $guia->id], 'method' => 'PUT', 'role' => 'form')) !!}
                  ...
                  <div class="mdl-grid ">
                      ...
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                          ...
                          <ul for="sample5" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                            @foreach(\App\Models\Pessoa::where('paciente', true)->get() as $pessoa)
                              <li class="mdl-menu__item" data-val="{{ $pessoa->id }}" {{ $pessoa->id == $guia->pessoa_id ? 'data-selected="true"' : '' }}>{{ $pessoa->nome }}</li>
                            @endforeach
                          </ul>
                      ...
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label getmdl-select getmdl-select__fix-height">
                          ...
                          <ul for="sample6" class="mdl-menu mdl-menu--bottom-left mdl-js-menu">
                            @foreach(\App\Models\Agendamento\Guia\Status::all() as $status)
                              <li class="mdl-menu__item" data-val="{{ $status->id }}" {{ $status->id == $guia->status_id ? 'data-selected="true"' : '' }}>{{ $status->nome }}</li>
                            @endforeach
                          </ul>
                    ...
                    <div class="mdl-cell mdl-cell--12-col-tablet mdl-cell--12-col-desktop">
                      <div class="mdl-textfield mdl-js-textfield mdl-textfield--floating-label mdl-select mdl-select__fullwidth {{ $errors->has('role') ? 'is-invalid' :'' }}">
                        {!! Form::text('valor', $guia->valor, array('id' => 'valor', 'class' => 'mdl-textfield__input money', 'required' => 'required')) !!}
            ...
            <div class="mdl-card__menu mdl-color-text--white">
              ...
              <a href="{{ route('guias.index') }}" class="mdl-button mdl-button--icon mdl-js-button mdl-js-ripple-effect mdl-color-text--white" title="Back to Users">
