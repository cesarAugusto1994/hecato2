<?php namespace App\Http\Controllers;
	...
	class AdminPermissionsController extends \crocodicstudio\crudbooster\controllers\CBController {
		...
		$this->col[] = array("label"=>"Guard Name","name"=>"guard_name" );
		...
		$this->form[] = ["label"=>"Guard Name","name"=>"guard_name","type"=>"text","required"=>TRUE,"validation"=>"required|min:1|max:255"];
